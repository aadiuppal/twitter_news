...
public class SplashActivity extends Activity {
    ...
    //String query = "123";
	//String RSSFEEDURL = "http://news.google.com/news?pz=1&cf=all&ned=us&hl=en&q="+query+"&output=rss";
    String RSSFEEDURL = "http://people.tamu.edu/~aadiuppal/489/news.xml";
	RSSFeed feed;
	String fileName;
